/**
 * Js Terminal - A Simple JS Terminal
 * Author: https://github.com/Zneiat
 */

/* Config */
window.TerminalConfig = {
    PromptText: '[<a id="username">root</a>@localhost <a id="working_directory">~</a>]#&nbsp;'
};
/* Start */
$(function() {
    // 布置PromptText
    ...
    document.onkeydown = function(Event) {
        ...
        if(oEvent.keyCode == 13){
            ...
            $('<div class="row"/>').html('<span>'+window.TerminalConfig.PromptText+ClipboardVal+'</span>').appendTo(TerminalOutput);
            if(ClipboardVal !== '') {
        ...
        function PressEnterAfterAction() {
            ...
            AddOneRow('You Input Content Is: '+Clipboard.val()+'<br/>You Can Change The 117 Line.');
/*            $.ajax({
                type: "POST",
                url: "action.php",
                dataType: "json",
